                    ...
                    <table class="w-full table-auto border mt-3"> 
                        <thead class="border-b">
                            <tr>
                                ...
                                <th class="text-sm font-medium text-gray-900 px-6 py-4">Sanksi</th>
                                <th class="text-sm font-medium text-gray-900 px-6 py-4">Mulai</th>
                                <th class="text-sm font-medium text-gray-900 px-6 py-4">Selesai</th>
